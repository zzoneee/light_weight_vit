...
class LightViT_DualToken_convEdgenextALL(nn.Module):
...
@register_model
def lightvit_dualToken_left_tiny_convEdgenextAll(pretrained=False, **kwargs):
    model_kwargs = dict(patch_size=8,
                        ...
                        **kwargs)
    model = LightViT_DualToken_convEdgenextALL(**model_kwargs)
    return model
