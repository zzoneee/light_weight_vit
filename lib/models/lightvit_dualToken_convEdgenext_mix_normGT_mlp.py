...
class LightViT_DualToken_convEdgenext_mix_normGT_mlp(nn.Module):
...
@register_model
def lightvit_dualToken_left_tiny_convEdgenext_mix_normGT_mlp(pretrained=False, **kwargs):
    model_kwargs = dict(patch_size=8,
...
# 1.053
#
# Number of backbone parameters: 11.854 M
