...
class LightViT_DualToken_convEdgenext(nn.Module):
...
@register_model
def lightvit_dualToken_left_tiny_convEdgenext(pretrained=False, **kwargs):
    model_kwargs = dict(patch_size=8,
                        ...
                        **kwargs)
    model = LightViT_DualToken_convEdgenext(**model_kwargs)
    return model
