...
class LightViT_DualToken_convEdgenext_mix_normGT_wsa(nn.Module):
...
@register_model
def lightvit_dualToken_left_tiny_convEdgenext_mix_normGT_wsa(pretrained=False, **kwargs):
    model_kwargs = dict(patch_size=8,
                        ...
                        # hydras=[False, False, True],
                        **kwargs)
    model = LightViT_DualToken_convEdgenext_mix_normGT_wsa(**model_kwargs)
    return model
