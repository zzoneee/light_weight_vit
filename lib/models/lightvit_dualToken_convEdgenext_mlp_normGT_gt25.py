...
class Attention(nn.Module):
    ...
    def forward(self, x, global_token, H, W):
        ...
        if self.use_sa_global:
            ...
            x_downsampleToken = F.interpolate(x_downsampleToken, size=(5, 5), mode='bicubic')
...
class LightViT_DualToken_convEdgenext_mlp_normGT_gt25(nn.Module):
...
@register_model
def lightvit_dualToken_left_tiny_convEdgenext_mlp_normGT_gt25(pretrained=False, **kwargs):
    model_kwargs = dict(patch_size=8,
                        ...
                        # hydras=[False, False, True],
                        **kwargs)
    model = LightViT_DualToken_convEdgenext_mlp_normGT_gt25(**model_kwargs)
    return model
...
# ^[[B(ev1) root@iZuf6hijpuiho6kt4lkaehZ:~/EasyCV-features-EdgeVit3#
# (ev1) root@iZuf6hijpuiho6kt4lkaehZ:~/EasyCV-features-EdgeVit3# python
# Python 3.6.13 |Anaconda, Inc.| (default, Jun  4 2021, 14:25:59)
# [GCC 7.5.0] on linux
# Type "help", "copyright", "credits" or "license" for more information.
# >>> 0.058+0.003+0.008+0.911+0.001
# 0.981
