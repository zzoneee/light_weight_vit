...
class Attention(nn.Module):
    ...
    def forward(self, x, global_token, H, W):
        ...
        if self.use_sa_global:
            ...
            x_downsampleToken = F.interpolate(x_downsampleToken, size=(3, 3), mode='bicubic')
...
class LightViT_DualToken_convEdgenext_mlp_normGT_gt9(nn.Module):
...
@register_model
def lightvit_dualToken_left_tiny_convEdgenext_mlp_normGT_gt9(pretrained=False, **kwargs):
    model_kwargs = dict(patch_size=8,
                        ...
                        # hydras=[False, False, True],
                        **kwargs)
    model = LightViT_DualToken_convEdgenext_mlp_normGT_gt9(**model_kwargs)
    return model
...
# |     addmm     | 0.001  |
# +---------------+--------+
# Total flops: 0.9G ± 0.0G
# (ev1) root@iZuf6hijpuiho6kt4lkaehZ:~/EasyCV-features-EdgeVit3# python
# Python 3.6.13 |Anaconda, Inc.| (default, Jun  4 2021, 14:25:59)
# [GCC 7.5.0] on linux
# Type "help", "copyright", "credits" or "license" for more information.
# >>> 0.058+0.003+0.007+0.863+0.001
# 0.932

# Number of backbone parameters: 11.851 M
# Number of backbone parameters requiring grad: 11.851 M
# Number of total parameters: 11.851 M
# Number of total parameters requiring grad: 11.851 M
