...
class LightViT_DualToken_convEdgenext_mix_normGT(nn.Module):
...
@register_model
def lightvit_dualToken_left_xxtiny_convEdgenext_mix_normGT(pretrained=False, **kwargs):
...
# |     addmm     | 0.001  |
# +---------------+--------+
# Total flops: 0.3G ± 0.0G
#
# Number of backbone parameters: 3.6436 M
...
@register_model
def lightvit_dualToken_left_tiny_convEdgenext_mix_normGT(pretrained=False, **kwargs):
    model_kwargs = dict(patch_size=8,
