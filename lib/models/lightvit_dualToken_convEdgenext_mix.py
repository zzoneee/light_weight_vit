...
class LightViT_DualToken_convEdgenext_mix(nn.Module):
...
@register_model
def lightvit_dualToken_left_tiny_convEdgenext_mix(pretrained=False, **kwargs):
    model_kwargs = dict(patch_size=8,
                        ...
                        **kwargs)
    model = LightViT_DualToken_convEdgenext_mix(**model_kwargs)
    return model
