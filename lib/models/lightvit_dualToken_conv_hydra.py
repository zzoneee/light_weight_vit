...
class LightViT_DualToken_conv_hydra(nn.Module):
...
@register_model
def lightvit_dualToken_left_tiny_conv_hydra(pretrained=False, **kwargs):
    model_kwargs = dict(patch_size=8,
                        ...
                        **kwargs)
    model = LightViT_DualToken_conv_hydra(**model_kwargs)
    return model
