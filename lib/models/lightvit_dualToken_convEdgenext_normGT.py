...
class LightViT_DualToken_convEdgenext_normGT(nn.Module):
...
@register_model
def lightvit_dualToken_left_tiny_convEdgenext_normGT(pretrained=False, **kwargs):
    model_kwargs = dict(patch_size=8,
                        ...
                        **kwargs)
    model = LightViT_DualToken_convEdgenext_normGT(**model_kwargs)
    return model
