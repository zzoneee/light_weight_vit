...
class LightViT_DualToken_convEdgenext_mix_normGT_gt36(nn.Module):
...
@register_model
def lightvit_dualToken_left_tiny_convEdgenext_mix_normGT_gt36(pretrained=False, **kwargs):
    model_kwargs = dict(patch_size=8,
                        ...
                        # hydras=[False, False, True],
                        **kwargs)
    model = LightViT_DualToken_convEdgenext_mix_normGT_gt36(**model_kwargs)
    return model
