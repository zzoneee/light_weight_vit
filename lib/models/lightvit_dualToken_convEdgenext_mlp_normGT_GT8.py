...
class LightViT_DualToken_convEdgenext_mlp_normGT_GT8(nn.Module):
...
@register_model
def lightvit_dualToken_left_tiny_convEdgenext_mlp_normGT_GT8(pretrained=False, **kwargs):
    model_kwargs = dict(patch_size=8,
                        ...
                        # hydras=[False, False, True],
                        **kwargs)
    model = LightViT_DualToken_convEdgenext_mlp_normGT_GT8(**model_kwargs)
    return model
...
# Number of backbone parameters: 13.357 M
# Number of backbone parameters requiring grad: 13.357 M
# Number of total parameters: 13.357 M
# Number of total parameters requiring grad: 13.357 M
