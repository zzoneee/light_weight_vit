...
class LightViT_DualToken_convEdgenext_mix_normGT_a03(nn.Module):
...
@register_model
def lightvit_dualToken_left_tiny_convEdgenext_mix_normGT_a03(pretrained=False, **kwargs):
    model_kwargs = dict(patch_size=8,
                        ...
                        # hydras=[False, False, True],
                        **kwargs)
    model = LightViT_DualToken_convEdgenext_mix_normGT_a03(**model_kwargs)
    return model

@register_model
def lightvit_dualToken_left_tiny_convEdgenext_mix_normGT_a05(pretrained=False, **kwargs):
    model_kwargs = dict(patch_size=8,
                        embed_dims=[64, 128, 256],
                        num_layers=[2, 6, 6],
                        num_heads=[2, 4, 8],
...
@register_model
def lightvit_dualToken_left_tiny_convEdgenext_mix_normGT_a07(pretrained=False, **kwargs):
    model_kwargs = dict(patch_size=8,
                        embed_dims=[64, 128, 256],
                        num_layers=[2, 6, 6],
                        num_heads=[2, 4, 8],
...
@register_model
def lightvit_dualToken_left_tiny_convEdgenext_mix_normGT_a09(pretrained=False, **kwargs):
    model_kwargs = dict(patch_size=8,
                        embed_dims=[64, 128, 256],
                        num_layers=[2, 6, 6],
                        num_heads=[2, 4, 8],
