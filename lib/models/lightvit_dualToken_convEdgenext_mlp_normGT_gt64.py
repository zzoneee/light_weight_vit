...
class Attention(nn.Module):
    ...
    def forward(self, x, global_token, H, W):
        ...
        if self.use_sa_global:
            ...
            x_downsampleToken = F.interpolate(x_downsampleToken, size=(8, 8), mode='bicubic')
...
class LightViT_DualToken_convEdgenext_mlp_normGT_gt64(nn.Module):
...
@register_model
def lightvit_dualToken_left_tiny_convEdgenext_mlp_normGT_gt64(pretrained=False, **kwargs):
    model_kwargs = dict(patch_size=8,
                        ...
                        # hydras=[False, False, True],
                        **kwargs)
    model = LightViT_DualToken_convEdgenext_mlp_normGT_gt64(**model_kwargs)
    return model
...
# |     addmm     | 0.001  |
# +---------------+--------+
# Total flops: 1.1G ± 0.0G
# 1.1

# Number of backbone parameters: 11.855 M
# Number of backbone parameters requiring grad: 11.855 M
# Number of total parameters: 11.855 M
# Number of total parameters requiring grad: 11.855 M
