...
class Attention(nn.Module):
    ...
    def forward(self, x, global_token, H, W):
        ...
        if self.use_sa_global:
            ...
            x_downsampleToken = F.interpolate(x_downsampleToken, size=(6, 6), mode='bicubic')
...
class LightViT_DualToken_convEdgenext_mlp_normGT_gt36(nn.Module):
...
@register_model
def lightvit_dualToken_left_tiny_convEdgenext_mlp_normGT_gt36(pretrained=False, **kwargs):
    model_kwargs = dict(patch_size=8,
                        ...
                        # hydras=[False, False, True],
                        **kwargs)
    model = LightViT_DualToken_convEdgenext_mlp_normGT_gt36(**model_kwargs)
    return model
...
# >>> 0.058+0.003+0.008+0.944+0.001
# 1.0139999999999998

# Number of backbone parameters: 11.853 M
# Number of backbone parameters requiring grad: 11.853 M
# Number of total parameters: 11.853 M
# Number of total parameters requiring grad: 11.853 M
