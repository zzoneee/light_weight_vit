...
def build_dataloader(args):
    ...
    if args.dataset == 'imagenet':
        ...
        train_dataset = ImageNetDataset(os.path.join('/dev/imagenet1k', 'train'), os.path.join('/dev/imagenet1k', 'train.txt'), transform=train_transforms_l)
    elif args.dataset == 'cifar10':
    ...
    if args.dataset == 'imagenet':
        ...
        val_dataset = ImageNetDataset(os.path.join('/dev/imagenet1k', 'val'), os.path.join('/dev/imagenet1k', 'val.txt'), transform=val_transforms_l)
    elif args.dataset == 'cifar10':
